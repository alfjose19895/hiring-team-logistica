<template>
    <div class="container_ md-12">
        <div class="row">
            <div class="col-xl-12 col-md-12">
                ...
                <div class="box col-md-12" id="sect_search">                             
                    <h4 class="header-title mb-3">PRODUCT MOVEMENT HISTORY</h4>   
                    <div id="form_search">
                            ...
                            <table id="idtable_cat" ref="table_cat" class="stripe " style="width:100%">
                                ...
                                <tbody>
                                    <tr v-for="item in products" :key="item.id_product" id="body">
                                        ...
                                        <td style="width:10%">
                                            <button type="button" class="btn btn-primary btn-sm" @click="detailHist(item.id_product)">Detail</button>
                                        </td>  
     ...
     <!-- Modal Hist -->
     <div class="modal fade" id="modal_Hist" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">        
                <div class="modal-body">
                    <span style="font-size: 150%; color: green" class="fa fa-edit"></span> 
                    <label id="title" class="modal-title" style="font-size: 130%; color: black ;">Detail Movements</label>
                    ...
                    <div class="x_content x_content_border_mobil">        
                        ...
                        <div class="col-md-12" style="margin-top:2px; margin-bottom: 10px;">

                            <div class="col-md-6">
                                <ul class="nav nav-pills nav-stacked">
                                    <li style="border-color: white"><a><i class="fa fa-credit-card text-red"></i> <b class="text-black" style="font-weight: 600 !important">Id</b>: <span  id="idProductTxt" style="font-weight: 500"></span></a></li>
                                    <li style="border-color: white"><a><i class="fa fa-barcode text-yellow"></i> <b class="text-black" style="font-weight: 600 !important">Code:</b> <span  id="CodeProductTxt" style="font-weight: 500"></span></a></li>
                                
                                </ul>
                            </div>     
                            <div class="col-md-6">
                                <ul class="nav nav-pills nav-stacked">
                                    <li style="border-color: white"><a><i class="fa fa-cart-plus text-red"></i> <b class="text-black" style="font-weight: 600 !important">Product:</b> <span  id="ProductTxt" style="font-weight: 500"></span></a></li>
                                    <li style="border-color: white"><a><i class="fa fa-crosshairs   text-yellow"></i> <b class="text-black" style="font-weight: 600 !important">Category</b>: <span  id="CategoryTxt" style="font-weight: 500"></span></a></li>
                                
                                </ul>
                            </div> 
                        </div>
                        
                        <div class="table-responsive" style="margin-top: 22px; margin-bottom: 20px;">                        
                            <table id="idtable_hist" ref="table_hist" class="stripe " style="width:100%">
                                <thead>
                                    <tr>
                                        <th  style="text-align: center" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" aria-sort="descending">Id</th>
                                ...
                                <tbody>
                                    <tr v-for="item in productsHist" :key="item.idrecord_movements" id="body">
                                        <td scope="row" style="width:10%">{{item.idrecord_movements}}</td>
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            changeTitle(){
               $('#titulo_header_content').html('HISTORY')               
            },   
            // datatable style  
            table(idtable){
                this.$nextTick(()=>{  
            ...
            async searchProductsHistory(){         
                try{                   
                    this.isLoading = true;
                    console.log(this.dataCategory)
                    await ProductService.searchProductsHistory(this.dataCategory).then(res=>{
                        this.isLoading = false;
                        console.log(res)
                        if(res.data.error==true){
            ...
            async detailHist(id){
                ...
                try{                   
                    ...
                    await ProductService.detailHistory(id).then(res=>{
                        this.isLoading = false;
                        console.log(res)
                        if(res.data.error==true){
                            this.messageNotificacion("An error occurred while trying to get the category data","error");
                        ...
                        window.$('#modal_Hist').modal('show');
                        this.productsHist=res.data.data
                        $(this.$refs.table_hist).DataTable().destroy();
                        this.table('idtable_hist')

                        $('#idProductTxt').html(res.data.data[0].id_product)
                        $('#CodeProductTxt').html(res.data.data[0].code_product)
                        $('#ProductTxt').html(res.data.data[0].product)
                        $('#CategoryTxt').html(res.data.data[0].category)
