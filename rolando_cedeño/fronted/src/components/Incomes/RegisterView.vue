        ...
        <div class="row">
            <div class="col-xl-12 col-md-12">
                ...
                <div class="box col-md-12" id="sect_search">                             
                    <h4 class="header-title mb-3">REGISTER INCOME</h4>   
                    ...
                    <form  class="form-horizontal form-label-left " autocomplete="off">
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <select2ajax v-model="dataIncome.product" class="input_prod select2" id='cmb_prod' :callback="url_search_prod"  placeholder="Search by code or name product ">
                                </select2ajax>
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="number" name="quantify" class="form-control" v-model="dataIncome.quantify" id="quantify" autocomplete="off"  placeholder="Enter a quantify">                                
                            </div>
                        ...
                        <div style="margin-top:22px; margin-bottom: 22px;" >
                            ...
                            <input type="hidden" v-model="dataIncome.idProdAdd" name="idProdAdd">
                            <input type="hidden" v-model="dataIncome.ProdAdd" name="ProdAdd">
                            <input type="hidden" v-model="dataIncome.CodeAdd" name="CodeAdd">
                            <input type="hidden" v-model="dataIncome.CateAdd" name="CateAdd">
                            <input type="hidden" v-model="dataIncome.IdCateAdd" name="IdCateAdd">
                            <input type="hidden" v-model="dataIncome.QuantifyAdd" name="QuantifyAdd">
                        </div> 
                        <div class="col-md-12 text-center" style="margin-bottom: 20px;">
                            <button type="submit" class="btn btn-success btn-sm btn_guarda " @click.prevent="storeIncome" >Save </button>    
                        </div>
                    </form>
                </div>                  
...
<script>
    ...
    export default{
        ...
        data(){           
            return{
                products_car:[],
                dataIncome:{product:'',quantify:'',idProdAdd:'',ProdAdd:'',CodeAdd:'',CateAdd:'',IdCateAdd:'',QuantifyAdd:''},
                btnAdd:false,
                btnEdit:false,
        ...
        methods: {
            ...
            storeIncome(){
                ...
                this.dataIncome.idProdAdd=idproduct_array
                this.dataIncome.ProdAdd=product_array
                this.dataIncome.CodeAdd=code_array
                this.dataIncome.CateAdd=category_array
                this.dataIncome.IdCateAdd=idcategory_array
                this.dataIncome.QuantifyAdd=quantify_array

                var nfilas=$("#carrito tr").length;
                if(nfilas===0){
                    this.messageNotificacion("Debe agregar al menos un producto", "error")
                    return
                }

                console.log(this.dataIncome)
                swal({
                    title: "Do you want to save the income?",
                    type: "warning",
            ...
            async processStore(){
                try{                   
                    this.isLoading = true;
                    await IncomeService.create(this.dataIncome).then(res=>{
                        this.isLoading = false;
                        console.log(res)
            ...
            changeTitle(){
               $('#titulo_header_content').html('Income')               
            },  
            
            clearFields(){
                this.products_car=[]
                this.dataIncome={product:'',quantify:'',idProdAdd:'',ProdAdd:'',CodeAdd:'',CateAdd:'',IdCateAdd:'',QuantifyAdd:''}
                $('#secctabla_items').hide();
                $('#secctabla_items_sd').show();
                $('#carrito tr').html('')
            },          
